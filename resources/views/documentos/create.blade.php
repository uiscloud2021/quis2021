        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'documentos.store', 'autocomplete' => 'off', 'id'=>'formcreate_documentos']) !!}

                        @include('documentos.resume')
...
@section('js')
    ...
    {{-- <script src="{{ asset('js/documentos.js?101') }}"></script> --}}
@stop
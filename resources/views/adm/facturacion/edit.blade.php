...
<h4 class="m-0">Editar facturación</h4>
@stop
...
<div class="card">
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            ...
            {!! Form::model($facturacion, ['route' => ['facturacion.update', $proyecto->id], 'method' => 'put', 'id'=>'formedit_facturacion']) !!}
...
@section('js')
    ...
    <script src="{{ asset('js/administracion/facturacion.js') }}"></script>
@stop
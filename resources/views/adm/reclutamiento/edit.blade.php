...
<h4 class="m-0">Editar reclutamiento</h4>
@stop
    ...
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            <div class="overlay" id="overlay" style="position:fixed; display:none">
                ...
                @if ($recl=="puestos")
                    {!! Form::model($puesto, ['route' => ['reclutamiento.update', $puesto->id], 'method' => 'put', 'id'=>'formedit_reclutamiento']) !!}
                    @include('adm/reclutamiento.form_puestos')
                @else
                    {!! Form::model($candidato, ['route' => ['reclutamiento.update', $candidato->id], 'method' => 'put', 'id'=>'formedit_reclutamiento']) !!}
				    @include('adm/reclutamiento.form_candidatos')
                @endif
               

                <div align="right">
                    <a href="/reclutamiento" class="btn btn-danger">Cancelar</a>

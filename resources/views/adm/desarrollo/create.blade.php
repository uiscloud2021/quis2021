...
<h4 class="m-0">Nuevo desarrollo</h4>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'desarrollo.store', 'autocomplete' => 'off', 'id'=>'formcreate_desarrollo']) !!}
...
@section('js')
    ...
    <script src="{{ asset('js/administracion/desarrollo.js') }}"></script>
@stop
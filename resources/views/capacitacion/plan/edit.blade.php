...
<h4 class="m-0">Editar plan de capacitación</h4>
@stop
...
<div class="card">
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            ...
            {!! Form::model($plan, ['route' => ['plan.update', $plan], 'method' => 'put', 'id'=>'formedit_plan']) !!}

			    {{--@include('capacitacion/plan.resume')--}}

                @include('capacitacion/plan.form')

                <div align="right">
                    <a href="/plan" class="btn btn-danger">Cancelar</a>

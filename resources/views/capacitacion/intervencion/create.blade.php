...
<h4 class="m-0">Nueva asistencia</h4>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'intervencion.store', 'autocomplete' => 'off', 'id'=>'formcreate_intervencion']) !!}

                        @include('capacitacion/intervencion.form')

                    <div align="right">
                        <a href="#" onclick="Salir();" class="btn btn-danger">Cancelar</a>
                        <button type="button" onclick="Guardar();" class="btn btn-primary"><i class="fas fa-save"> Guardar asistencia</i></button>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('js/capacitacion/intervencion.js?5') }}"></script>
@stop
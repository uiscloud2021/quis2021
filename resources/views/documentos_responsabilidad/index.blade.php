...
<h4 class="m-0">Documentos Responsabilidad</h4>
@stop
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-1-tab" data-toggle="pill" href="#vert-tabs-1" onclick="cambiarCapacitacion('assets/D/Ca-D Responsabilidad.pdf');" role="tab" aria-controls="vert-tabs-1" aria-selected="false"> Ca-D Responsabilidad</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-2-tab" data-toggle="pill" href="#vert-tabs-2" onclick="cambiarManuales('assets/D/1M-D Responsabilidad Social.pdf');" role="tab" aria-controls="vert-tabs-2" aria-selected="false"> 1M-D Responsabilidad Social</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-3-tab" data-toggle="pill" href="#vert-tabs-3" onclick="cambiarProcesos('assets/D/PC-D Responsabilidad.pdf');" role="tab" aria-controls="vert-tabs-3" aria-selected="false"> PC-D Responsabilidad</a>
                                                    </li> 
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/D/PNO-D-101 Planeacion.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-D-101 Planeación</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/D/PNO-D-201 Desarrollo.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-D-201 Desarrollo</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-5-tab" data-toggle="pill" href="#vert-tabs-5" onclick="cambiarInstructivos('assets/D/IT-D Responsabilidad.pdf');" role="tab" aria-controls="vert-tabs-5" aria-selected="false"> IT-D Responsabilidad</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{ asset('js/documentos_responsabilidad.js?1') }}"></script>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'versiones.store', 'autocomplete' => 'off', 'id'=>'formcreate_versiones']) !!}

				               @include('calidad/versiones.form')

                    <div align="right">
                        <a href="#" onclick="Salir();" class="btn btn-danger">Cancelar</a>
                        <button type="button" onclick="Guardar();" class="btn btn-primary"><i class="fas fa-save"> Guardar versión</i></button>
                    </div>
...
<script src="https://code.jquery.com/jquery-3.5.1.js"></script>
    ...
    <script src="{{ asset('js/calidad/versiones.js') }}"></script>

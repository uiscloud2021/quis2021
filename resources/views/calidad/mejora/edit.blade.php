...
<h4 class="m-0">Editar no conformidad</h4>
@stop
...
<div class="card">
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            ...
            {!! Form::model($mejora, ['route' => ['mejora.update', $mejora], 'method' => 'put', 'id'=>'formedit_mejora']) !!}

                @include('calidad/mejora.resume')

			    @include('calidad/mejora.form')

                <div align="right">
                    <a href="/mejora" class="btn btn-danger">Cancelar</a>
...
@section('js')
    ...
    <script src="{{ asset('js/calidad/mejora.js') }}"></script>
@stop
...
<h4 class="m-0">Nueva no conformidad</h4>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'mejora.store', 'autocomplete' => 'off', 'id'=>'formcreate_mejora']) !!}

                        @include('calidad/mejora.form')

                    <div align="right">
                        <a href="#" onclick="Salir();" class="btn btn-danger">Cancelar</a>
                        <button type="button" onclick="Guardar();" class="btn btn-primary"><i class="fas fa-save"> Guardar no conformidad</i></button>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('js/calidad/mejora.js?1') }}"></script>
@stop
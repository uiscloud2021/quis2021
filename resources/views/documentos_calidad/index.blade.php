...
<h4 class="m-0">Documentos Calidad</h4>
@stop
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-1-tab" data-toggle="pill" href="#vert-tabs-1" onclick="cambiarCapacitacion('assets/A/Ca-A Capacitacion.pdf');" role="tab" aria-controls="vert-tabs-1" aria-selected="false"> Ca-A Capacitación</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-2-tab" data-toggle="pill" href="#vert-tabs-2" onclick="cambiarManuales('assets/A/1M-A Calidad.pdf');" role="tab" aria-controls="vert-tabs-2" aria-selected="false"> 1M-A Calidad</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-3-tab" data-toggle="pill" href="#vert-tabs-3" onclick="cambiarProcesos('assets/A/PC-A Calidad.pdf');" role="tab" aria-controls="vert-tabs-3" aria-selected="false"> PC-A Calidad</a>
                                                    </li> 
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/A/PNO-A-101 Planeacion.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-A-101 Planeación</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/A/PNO-A-201 Implementacion.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-A-201 Implementación</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/A/PNO-A-301 Auditoria.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-A-301 Auditoría</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/A/PNO-A-401 Mejora.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-A-401 Mejora</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-5-tab" data-toggle="pill" href="#vert-tabs-5" onclick="cambiarInstructivos('assets/A/IT-A Calidad.pdf');" role="tab" aria-controls="vert-tabs-5" aria-selected="false"> IT-A Calidad</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" onclick="cambiarFormatos('assets/A/FC-A-2011 Informe de reunion.docx');" role="tab" aria-controls="vert-tabs-6" aria-selected="false"> FC-A-2011 Informe de reunión</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" onclick="cambiarFormatos('assets/A/FC-A-3011 Informe de auditoria.docx');" role="tab" aria-controls="vert-tabs-6" aria-selected="false"> FC-A-3011 Informe de auditoría</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>

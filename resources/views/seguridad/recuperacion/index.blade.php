            ...
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    <div class="overlay" id="overlay" style="position:fixed; display:none">
                        ...
                        @include('seguridad/recuperacion.form')
...
<!--MODALS-->
@include('seguridad/recuperacion.modals')
...
@section('js')
    ...
    <script src="{{ asset('js/seguridad/recuperacion.js?2') }}"></script>
@stop
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="vert-tabs-1" role="tabpanel" aria-labelledby="vert-tabs-1-tab">
                    ...
                    <div class="table-responsive">
                        <div align="left">
                            <button type="button" class="btn btn-info" onclick="CreateRecuperacion();">
                                <i class="fas fa-file"> Agregar revisión</i>
                            </button>  
                        </div><br/>
                        <table id="tbl_recuperacion" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%;">

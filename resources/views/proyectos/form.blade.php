    <div class="card card-primary card-outline">
          <div class="card-header">
            ...
            <div style="float:right">
                <button type="button" onclick="location.href='{{ route('proyectos.index') }}'" class="btn-warning" title="Regresar"><i class="fa fa-arrow-left"></i></button>
            </div>
          </div>
          <div class="card-body">
            <div class="row">
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                  ...
                  <div class="tab-pane fade" id="vert-tabs-2" role="tabpanel" aria-labelledby="vert-tabs-2-tab">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('no27', ['Abierto' => 'Abierto', 'Cerrado' => 'Cerrado', 'Revisión' => 'Revisión por Comité de Ética'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione...']) !!}
                    </div>
                    </div>
                  ...
                  <div class="tab-pane fade" id="vert-tabs-3" role="tabpanel" aria-labelledby="vert-tabs-3-tab">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::select('investigador_id', $investigadores, null, ['class' => 'form-control select2 select2-selection', 'id' =>'inv_id', 'style' => 'width: 100%', 'onchange' => 'Investigador(this.value);', 'placeholder' => 'Nuevo...']) !!}
                    </div>

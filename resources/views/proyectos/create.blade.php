...
<h4 class="m-0">Nuevo proyecto</h4>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'proyectos.store', 'autocomplete' => 'off', 'id'=>'formcreate_proyecto']) !!}

				      @include('proyectos.form')

                    <div align="right">
                        <a href="#" onclick="Salir();" class="btn btn-danger">Cancelar</a>
                        <button type="button" onclick="Guardar();" class="btn btn-primary"><i class="fas fa-save"> Guardar proyecto</i></button>
                    </div>

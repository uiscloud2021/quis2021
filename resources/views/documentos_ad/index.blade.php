...
@section('title', 'Documentos AD')

@section('content_header')
<h4 class="m-0">Documentos Administración</h4>
@stop
                                ...
                                <div class="row">
                                    ...
                                    <div class="col col-sm">
                                        <div class="card" id="buscador">
                                            <div class="card-header">
                                                <h6 id="nombre_codigo">Seleccione un formato</h6>
                                                    ...
                                                    <table id="table-formato" class="table table-striped table-hover table-bordered shadow-lg mt-2" style="width:100%;">
                                                        <thead class="bg-mexg1 text-white">
                                                            <tr>
                                                                ...
                                                                {{-- <th scope="col">Código UIS / Investigador Principal</th> --}}
...
@section('js')
    ...
    <script src="{{ asset('js/documentos_ad.js?4') }}"></script>
@stop
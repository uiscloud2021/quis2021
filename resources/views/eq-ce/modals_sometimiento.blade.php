...
<div class="modal fade" id="createProtocoloSomModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="createProtocoloSomModalLabel">Nuevo protocolo</h5>
        <button type="button" class="close" data-bs-dismiss="modal" aria-label="Cancelar">
            <span aria-hidden="true">&times;</span>
        </button>
      </div>
      {!! Form::open(['autocomplete' => 'off', 'method'=>'POST', 'id'=>'formcreate_protocolosom']) !!}
      <div class="modal-body">
        {!! Form::hidden('empresaid_protocolosom', null, ['id' => 'empresaid_protocolosom']) !!}
        {!! Form::hidden('proyectoid_protocolosom', null, ['id' => 'proyectoid_protocolosom']) !!}
        {!! Form::hidden('sometimientoid_protocolosom', null, ['id' => 'sometimientoid_protocolosom']) !!}
        {!! Form::hidden('fechaid_protocolosom', null, ['id' => 'fechaid_protocolosom']) !!}
        {!! Form::hidden('id_protocolosom', null, ['id' => 'id_protocolosom']) !!}
        
        <div class="form-group" id="divs19">
            {!! Form::label('s19', '19. Nombre', ['class' => 'form-label']) !!}
            {!! Form::textarea('s19', null, ['class' => 'form-control', 'id' => 's19', 'placeholder' => 'Ingrese nombre']) !!}
        </div>

        <div class="form-group" id="divs20">
            {!! Form::label('s20', '20. Idioma', ['class' => 'form-label']) !!}
            {!! Form::select('s20', ['Inglés' => 'Inglés', 'Español' => 'Español', 'Ambos' => 'Ambos'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione...', 'id' => 's20']) !!}
        </div>

        <div class="form-group" id="divs21">
            {!! Form::label('s21', '21. Versión', ['class' => 'form-label']) !!}
            {!! Form::text('s21', null, ['class' => 'form-control', 'id' => 's21', 'placeholder' => 'Ingrese versión']) !!}
        </div>

        <div class="form-group" id="divs22">
            {!! Form::label('s22', '22. Fecha', ['class' => 'form-label']) !!}
            <div class="input-group-prepend">
                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                {!! Form::date('s22', null, ['class' => 'form-control', 'id' => 's22']) !!}
            </div>
        </div>

        <div class="form-group" id="divs23">
            {!! Form::label('s23', '23. Corresponde a una enmienda', ['class' => 'form-label']) !!}
            <div>
              <label>
                {!! Form::radio('s23', 'Si', null, ['class' => 'mr-1', 'id' => 's23_si']) !!}
                  Si
              </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
              <label>
                {!! Form::radio('s23', 'No', null, ['class' => 'mr-1', 'id' => 's23_no']) !!}
                  No
              </label>
            </div>
        </div>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" id="btnGProtocoloSom" class="btn btn-success"><i class="fas fa-save"> Guardar</i></button>
      </div>
      {!! Form::close() !!}
    </div>
  </div>

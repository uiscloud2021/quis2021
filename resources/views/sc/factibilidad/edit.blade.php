...
<h4 class="m-0">Editar factibilidad</h4>
@stop
...
<div class="card">
    <div class="card-body">
        <div class="overlay-wrapper col-md-12">
            ...
            {!! Form::model($factibilidad, ['route' => ['factibilidad.update', $proyecto->id], 'method' => 'put', 'id'=>'formedit_factibilidad']) !!}
                ...
                <div align="right">
                    <a href="/factibilidad" class="btn btn-danger">Cancelar</a>
...
@section('js')
    ...
    <script src="{{ asset('js/sc/factibilidad.js?2') }}"></script>
@stop
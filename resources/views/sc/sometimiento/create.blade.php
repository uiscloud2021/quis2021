...
<h4 class="m-0">Nuevo sometimiento</h4>
@stop
        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::open(['route' => 'sometimiento.store', 'autocomplete' => 'off', 'id'=>'formcreate_sometimiento']) !!}
                    ...
                    <div align="right">
                        ...
                        <button type="button" onclick="Guardar();" class="btn btn-primary"><i class="fas fa-save"> Guardar sometimiento</i></button>
                    </div>
...
@section('js')
    ...
    <script src="{{ asset('js/sc/sometimiento.js?1') }}"></script>
@stop
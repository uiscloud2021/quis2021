                ...
                <div class="card">
                    ...
                    <div class="card-body p-0">
                        <ul class="nav flex-column nav-tabs">
                            <li class="nav-item">
                                <a class="nav-link active" id="vert-tabs-1-tab" data-toggle="pill" href="#vert-tabs-1" role="tab" aria-controls="vert-tabs-1" aria-selected="false"><i class="far fa-edit"></i> Infraestructura</a>
                            </li>
                ...
                <div class="tab-content" id="vert-tabs-tabContent">
                  ...
                  <div class="tab-pane fade show active" id="vert-tabs-1" role="tabpanel" aria-labelledby="vert-tabs-1-tab">
                    ...
                    ?>
                        ...
                        {!! Form::hidden('id', null, ['class' => 'form-control', 'id'=>'instalacion_id']) !!}
                    ...
                    <div class="table-responsive">
                        <div align="left">
                            <button type="button" class="btn btn-info" onclick="CreateInstalacion();">
                                <i class="fas fa-file"> Agregar revisión</i>
                            </button>  
                        </div><br/>
                        <table id="tbl_instalacion" class="table table-striped table-bordered shadow-lg mt-4" style="width:100%;">

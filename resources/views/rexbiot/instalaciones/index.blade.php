            ...
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    <div class="overlay" id="overlay" style="position:fixed; display:none">
                        ...
                        @include('rexbiot/instalaciones.form')
...
<!--MODALS-->
@include('rexbiot/instalaciones.modals')
...
@section('js')
    ...
    <script src="{{ asset('js/rexbiot/instalaciones.js?2') }}"></script>
@stop
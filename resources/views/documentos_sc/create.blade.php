        ...
        <div class="card-body">
            <div class="row">
                <div class="overlay-wrapper col-md-12">
                    ...
                    {!! Form::hidden('otro', 'false', ['class' => 'form-control', 'id'=>'otro']) !!}

                    {!! Form::open(['route' => 'documentos_sc.store_cv', 'autocomplete' => 'off', 'id'=>'formcreate_documentosCV']) !!}
...
@section('js')
    ...
    <script src="{{ asset('js/documentos_cv.js?9') }}"></script>
@stop
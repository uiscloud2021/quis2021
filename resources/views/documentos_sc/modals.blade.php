...
<div class="modal fade" id="createFormatoModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        ...
        <div class="modal-content" id="content_presentacion">
            ...
            {{-- Presentacion --}}
            <div style="display: none" id="body-1" name="body-presentacion">
            <div class="modal-body">
            ...
            {{-- Publicidad --}}
            <div style="display: none" id="body-3" name="body-publicidad">
                <div class="modal-body">
                ...
                {{-- Codigo y titulo --}}
                <div style="display: none" id="body-4" name="body-codigoTitulo">
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="div3">
                            {!! Form::label('4no3', '3. Número de sitio', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-hashtag"></i></span>
                                {!! Form::text('4no3', null, ['class' => 'form-control', 'placeholder' => 'Número de sitio', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div4">
                            {!! Form::label('4no4', 'Título', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-5">
                                ...
                                <div class="form-group">
                                    ...
                                    {!! Form::text('4no4', null, ['class' => 'form-control', 'placeholder' => 'Título', 'required']) !!}
                                    </div>
                                </div>
                        ...
                        <div class="form-group" id="div5">
                            {!! Form::label('4no', 'Nicknames del estudio', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div8">
                            {!! Form::label('4no', 'Empresas', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div10">
                            {!! Form::label('4no', 'Investigador principal', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div14">
                            {!! Form::label('4no', 'Sub-investigador', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div18">
                            {!! Form::label('4no', 'Coordinadores de estudio', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div19">
                            {!! Form::label('4no', 'Monitor', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div23">
                            {!! Form::label('4no', 'Laboratorio', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div28">
                            {!! Form::label('4no', 'Recolección de muestras biológicas', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div33">
                            {!! Form::label('4no', 'eCRF', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div39">
                            {!! Form::label('4no', 'IVRS', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                        ...
                        <div class="form-group" id="div44">
                            {!! Form::label('4no', 'Otros', ['class' => 'form-label']) !!}
                            <div class="p-2 rounded border border-dark">
                ...
                {{-- Sometimiento --}}
                <div style="display: none" id="body-7" name="body-sometimiento">
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="div7">
                            {!! Form::label('7no7', '7. Domicilio', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-home"></i></span>
                                {!! Form::text('7no7', null, ['class' => 'form-control', 'placeholder' => 'Domicilio', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div8">
                            {!! Form::label('7no8', '8. Nombre del Investigador principal', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('7no8', null, ['class' => 'form-control', 'placeholder' => 'Investigador principal', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div9">
                            {!! Form::label('7no9', '9. Documentos', ['class' => 'form-label']) !!}
                            <div id="wrapper_sometimiento">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-file-alt"></i></span>
                                {!! Form::text('7no9', null, ['class' => 'form-control', 'placeholder' => 'Nombre, version y Fecha del documento', 'required']) !!}
                ...
                {{-- Compromisos --}}
                <div style="display: none" id="body-8" name="body-compromisos">
                    <div class="modal-body">
                ...
                {{-- Responsabilidades --}}
                <div style="display: none" id="body-9" name="body-responsabilidades">
                    <div class="modal-body">
                ...
                {{-- Autorizacion --}}
                <div style="display: none" id="body-10" name="body-autorizacion">
                    <div class="modal-body">
                ...
                {{-- Instalaciones --}}
                <div style="display: none" id="body-11" name="body-instalaciones">
                    <div class="modal-body">
                ...
                {{-- Anticorrupcion --}}
                <div style="display: none" id="body-12" name="body-anticorrupcion">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-27" name="body-destruccionmateriales">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-28" name="body-destruccionproductos">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-56" name="body-documentofuente">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-57" name="body-hojainicial">
                    <div class="modal-body">
                ...
                {{-- Contacto --}}
                <div style="display: none" id="body-58" name="body-contacto">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-77" name="body-privicidadsujetos">
                    <div class="modal-body">
                ...
                {{-- Privacidad y datos --}}
                <div style="display: none" id="body-0" name="body-privacidaddatos">
                    <div class="modal-body">
                ...
                {{-- Orden de compra --}}
                <div style="display: none" id="body-79" name="body-ordencompra">
                    <div class="modal-body">
                ...
                {{-- Envío de muestras --}}
                <div style="display: none" id="body-80" name="body-enviomuestras">
                    <div class="modal-body">
                ...
                <div style="display: none" id="body-81" name="body-ordencomprahospital">
                    <div class="modal-body">
                        ...
                        <div class="form-group" id="div6">
                            ...
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('81no6', null, ['class' => 'form-control', 'placeholder' => 'Nombre de la persona que solicita', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div7">
                            {!! Form::label('81no7', '7. Puesto', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('81no7', null, ['class' => 'form-control', 'placeholder' => 'Puesto', 'required']) !!}
                            </div>
                        </div>

                        <div class="ordencompraHospitalCampos">
                            <div class="form-group" id="div8">
                                {!! Form::label('81no', '8. Por este medio solicito que atención para:', ['class' => 'form-label']) !!}
                                <div id="wrapper_ordensujeto">
                                    {!! Form::label('81no8', '', ['class' => 'form-label', 'hidden']) !!}
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-user"></i></span>
                                    {!! Form::text('81no8', null, ['class' => 'form-control','placeholder' => 'Nombre del sujeto', 'required']) !!}
                                    <button type="button" id="add_sujeto_orden" class="btn btn-primary" title="Agregar campo"><i class="fas fa-plus-square"></i></button>
                                </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group" id="div9">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    {!! Form::text('81no9', null, [ 'id' => '81no9', 'name' => '81no9', 'class' => 'ordencomprahospitalServicio form-control','placeholder' => 'Nombre del servicio', 'required']) !!}
                            ...
                            <div class="form-group" id="div10">
                                ...
                                <div class="input-group-prepend">
                                    ...
                                    {!! Form::text('81no10', null, [ 'id' => '81no10', 'name' => '81no10' ,'class' => 'ordencomprahospitalRestriccion form-control','placeholder' => 'Restricción', 'required']) !!}
                ...
                {{-- Aviso EAS --}}
                <div style="display: none" id="body-82" name="body-avisoeas">
                    <div class="modal-body">
                ...
                {{-- Aviso SUSAR --}}
                <div style="display: none" id="body-83" name="body-avisosusar">
                    <div class="modal-body">
                ...
                {{-- Somete desviación --}}
                <div style="display: none" id="body-84" name="body-sometedesviacion">
                    <div class="modal-body">
                ...
                {{-- Aviso al CE --}}
                <div style="display: none" id="body-85" name="body-avisoce">
                    <div class="modal-body">
                ...
                {{-- Fe de erratas --}}
                <div style="display: none" id="body-86" name="body-fedeerratas">
                    <div class="modal-body">
                ...
                {{-- Renovacion anual --}}
                <div style="display: none" id="body-87" name="body-renovacionanual">
                    <div class="modal-body">
                ...
                {{-- Informte técnico --}}
                <div style="display: none" id="body-88" name="body-informetecnico">
                    <div class="modal-body">
                ...
                {{-- Aviso de cierre --}}
                <div style="display: none" id="body-89" name="body-avisocierre">
                    <div class="modal-body">
                ...
                {{-- Archivo muerto --}}
                <div style="display: none" id="body-90" name="body-archivomuerto">
                    <div class="modal-body">
                        {!! Form::open(['autocomplete' => 'off', 'method'=>'POST', 'id'=>'formcreate_archivoMuerto']) !!}
        
                        <div class="form-group" id="div1">
                            {!! Form::label('90no1', '1. Código UIS', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="far fa-archive"></i></span>
                                {!! Form::text('90no1', null, ['class' => 'form-control', 'placeholder' => 'Código UIS', 'readonly','required']) !!}
                                {{-- {!! Form::select('90no1', [ 'Chihuahua, Chih.' => 'Chihuahua, Chih.', 'Ciudad de México' => 'Ciudad de México', 'Zapopan, Jal.' => 'Zapopan, Jal.' ],null, ['class' => 'form-control', 'placeholder' => 'Seleccione una ciudad', 'required']) !!} --}}
                            </div>
                        </div>
        
                        <div class="form-group" id="div2">
                            {!! Form::label('90no2', '2. Depurar en Fecha', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                {!! Form::date('90no2', null, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div3">
                            {!! Form::label('90no3', '3. # Caja', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-hashtag"></i></span>
                                {!! Form::number('90no3', null, ['class' => 'form-control', 'placeholder' => '# Caja', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div4">
                            {!! Form::label('90no4', '4. Total Cajas', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-hashtag"></i></span>
                                {!! Form::number('90no4', null, ['class' => 'form-control', 'placeholder' => 'Total Cajas', 'required']) !!}
                            </div>
                        </div>
                
                    </div>
                    <div class="modal-footer">
                        <button type="button" id="btnCarchivomuerto" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" id="btnGarchivomuerto" class="btn btn-success"><i class="fas fa-save"> Guardar</i></button>
                    </div>
                    {!! Form::close() !!}
                </div>
                {{-- END Archivo muerto --}}
                ...
                {{-- Cambio de domicilio --}}
                <div style="display: none" id="body-91" name="body-cambiodomicilio">
                    <div class="modal-body">
                        {!! Form::open(['autocomplete' => 'off', 'method'=>'POST', 'id'=>'formcreate_cambioDomicilio']) !!}
        
                        <div class="form-group" id="div1">
                            {!! Form::label('91no1', '1. Fecha', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                {!! Form::date('91no1', null, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div2">
                            {!! Form::label('91no2', '2. Nombre del destinatario', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no2', null, ['class' => 'form-control', 'placeholder' => 'Nombre del destinatario', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div3">
                            {!! Form::label('91no3', '3. Puesto', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no3', null, ['class' => 'form-control', 'placeholder' => 'Puesto', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div4">
                            {!! Form::label('91no4', '4. Empresa', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no4', null, ['class' => 'form-control', 'placeholder' => 'Empresa', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div5">
                            {!! Form::label('91no5', '5. Código', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no5', null, ['class' => 'form-control', 'placeholder' => 'Código', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div6">
                            {!! Form::label('91no6', '6. Título', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-pen-square"></i></span>
                                {!! Form::text('91no6', null, ['class' => 'form-control', 'placeholder' => 'Título', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div7">
                            {!! Form::label('91no7', '7. Patrocinador', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('91no7', null, ['class' => 'form-control', 'placeholder' => 'Patrocinador', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div8">
                            {!! Form::label('91no8', '8. Título del destinatario', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user-tie"></i></i></span>
                                {!! Form::text('91no8', null, ['class' => 'form-control', 'placeholder' => 'Título abreviado del destinatario (Dr, Dra, Ing. etc.)', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div9">
                            {!! Form::label('91no9', '9. Apellido del destinatario', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no9', null, ['class' => 'form-control', 'placeholder' => 'Primer apellido del destinatario', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div10">
                            {!! Form::label('91no10', '10. Nuevo domicilio', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::textarea('91no10', null, ['class' => 'form-control', 'rows' => '4','placeholder' => 'Escribir nuevo domicilio', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div11">
                            {!! Form::label('91no11', '11. Nombre de quien notifica', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no11', null, ['class' => 'form-control', 'placeholder' => 'Dr/Dra Nombre completo de quien notifica', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div12">
                            {!! Form::label('91no12', '12. Puesto', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('91no12', null, ['class' => 'form-control', 'placeholder' => 'Puesto de quien notifica', 'required']) !!}
                            </div>
                        </div>
                ...
                <div style="display: none" id="body-105" name="body-sometimientoMigracion">
                    <div class="modal-body">
                        {!! Form::open(['autocomplete' => 'off', 'method'=>'POST', 'id'=>'formcreate_sometimientoMigracion']) !!}


                        <div class="form-group" id="div1">
                            {!! Form::label('105no1', '1. Ciudad', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-city"></i></span>
                                {!! Form::text('105no1', null, ['class' => 'form-control', 'placeholder' => 'Ciudad', 'readonly','required']) !!}
                                {{-- {!! Form::select('105no1', [ 'Chihuahua, Chih.' => 'Chihuahua, Chih.', 'Ciudad de México' => 'Ciudad de México', 'Zapopan, Jal.' => 'Zapopan, Jal.' ],null, ['class' => 'form-control', 'placeholder' => 'Seleccione una ciudad', 'required']) !!} --}}
                            </div>
                        </div>
        
                        <div class="form-group" id="div2">
                            {!! Form::label('105no2', '2. Fecha', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                {!! Form::date('105no2', null, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div3">
                            {!! Form::label('105no3', '3. Código UIS', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('105no3', null, ['class' => 'form-control', 'placeholder' => 'Código UIS', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div4">
                            {!! Form::label('105no4', '4. Código', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('105no4', null, ['class' => 'form-control', 'placeholder' => 'Código', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div5">
                            {!! Form::label('105no5', '5. Título', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-pen-square"></i></span>
                                {!! Form::text('105no5', null, ['class' => 'form-control', 'placeholder' => 'Título', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div6">
                            {!! Form::label('105no6', '6. Patrocinador', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('105no6', null, ['class' => 'form-control', 'placeholder' => 'Patrocinador', 'readonly']) !!}
                            </div>
                        </div>

                        @if (session('id_empresa') == 2)
                            <div class="form-group" id="div7">
                                {!! Form::label('105no7', '7. Domicilio', ['class' => 'form-label']) !!}
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-clinic-medical"></i></span>
                                    {{-- {!! Form::select('105no8', [ 'Trasviña y Retes 1317, Colonia San Felipe, Chihuahua, Chih., CP 31203, México.' => 'Trasviña y Retes 1317, Colonia San Felipe, Chihuahua, Chih., CP 31203, México.', 'Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.', 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.', 'Unidad Nacional 1299, Conjunto Patria, Zapopan, Jal. CP 45150, México.' => 'Unidad Nacional 1299, Conjunto Patria, Zapopan, Jal. CP 45150, México.'],null, ['class' => 'form-control', 'placeholder' => 'Seleccione un Domicilio', 'required']) !!} --}}
                                    {!! Form::select('105no7', ['Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.', 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.'], null, ['class' => 'form-control', 'placeholder' => 'Seleccione una dirección', 'required']) !!}
                                </div>
                            </div> 
                        @else
                            <div class="form-group" id="div7">
                                ...
                                <div class="input-group-prepend">
                                    <span class="input-group-text"><i class="fas fa-clinic-medical"></i></span>
                                    {!! Form::text('105no7', null, ['class' => 'form-control', 'placeholder' => 'Dirección Domicilio', 'readonly']) !!}
                                    {{-- {!! Form::select('105no8', [ 'Trasviña y Retes 1317, Colonia San Felipe, Chihuahua, Chih., CP 31203, México.' => 'Trasviña y Retes 1317, Colonia San Felipe, Chihuahua, Chih., CP 31203, México.', 'Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Puente de piedra 150, Torre 2, Planta baja, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.', 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.' => 'Renato Leduc 151-4, Colonia Toriello Guerra, Tlalpan, Ciudad de México, CP 14050, México.', 'Unidad Nacional 1299, Conjunto Patria, Zapopan, Jal. CP 45150, México.' => 'Unidad Nacional 1299, Conjunto Patria, Zapopan, Jal. CP 45150, México.'],null, ['class' => 'form-control', 'placeholder' => 'Seleccione un sitio clínico', 'required']) !!} --}}
                                </div>
                            </div>
                        @endif
                        ...
                        <div class="form-group" id="div8">
                            {!! Form::label('105no', '8. Fechas de aprobación', ['class' => 'form-label']) !!}
                            ...
                            <div id="wrapper_renovacionanual">
                                ...
                                <div class="renovacionanualinpust p-2 rounded border">
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no8', 'Comité de Ética en Investigación', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <!-- TODO: ver de donde se toma la fecha o si el usuario ingresara la fecha -->
                                            {!! Form::date('105no8', null, ['class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no9', 'Comité de Investigación', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            {!! Form::date('105no9', null, ['class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no10', 'COFEPRIS', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            <!-- TODO: ver si se queda como date o como caja de texto -->
                                            {{-- {!! Form::date('105no10', null, ['class' => 'form-control', 'required']) !!} --}}
                                            {!! Form::text('105no10', null, ['class' => 'form-control', 'placeholder' => 'Pendiente o fecha, ejemplo: 24-Mayo-2022 (Año-Mes-Día)', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group" id="div11">
                            {!! Form::label('105no', '11. Informe correspondiente', ['class' => 'form-label']) !!}
                            ...
                            <div id="wrapper_renovacionanual">
                                ...
                                <div class="renovacionanualinpust p-2 rounded border">
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no11', 'Estado del proyecto', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                            {!! Form::select('105no11', [ 'Espera visita de inicio' => 'Espera visita de inicio', 'En conducción' => 'En conducción', 'Cerrado' => 'Cerrado' ], null, ['class' => 'form-control', 'placeholder' => 'Seleccione estado del proyecto', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no12', 'Fecha de visita de inicio', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-folder"></i></span>
                                            {!! Form::date('105no12', null, ['class' => 'form-control', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no13', 'Sujetos que firmaron ICF', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-users"></i></span>
                                            {!! Form::text('105no13', null, ['class' => 'form-control', 'placeholder' => '# Sujetos', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no14', 'Sujetos activos o en seguimiento', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-users"></i></span>
                                            {!! Form::text('105no14', null, ['class' => 'form-control', 'placeholder' => '# Sujetos', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no15', 'Total de informes iniciales de EAS en el sitio', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-file-alt"></i></span>
                                            {!! Form::text('105no15', null, ['class' => 'form-control', 'placeholder' => '# EAS', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col form-group">
                                            {!! Form::label('105no16', 'Total de desviaciones o violaciones en el sitio', ['class' => 'form-label']) !!}
                                            <div class="input-group-prepend">
                                            <span class="input-group-text"><i class="fas fa-file-alt"></i></span>
                                            {!! Form::text('105no16', null, ['class' => 'form-control', 'placeholder' => '# Desviaciones', 'required']) !!}
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="form-group" id="div17">
                            {!! Form::label('105no17', '17. Investigador principal', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('105no17', null, ['class' => 'form-control', 'placeholder' => 'Investigador', 'readonly']) !!}
                            </div>
                        </div>


                        <div class="form-group" id="div18">
                            {!! Form::label('105no18', '18. Documentos que se someten con fines de migración', ['class' => 'form-label']) !!}
                            <div id="wrapper_sometimientoMigracion">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-file-alt"></i></span>
                                {!! Form::text('105no18', null, ['class' => 'form-control', 'placeholder' => 'Nombre, version y Fecha del documento', 'required']) !!}
                                <button type="button" id="add_documentoMigracion" class="btn btn-primary" title="Agregar campo"><i class="fas fa-plus-square"></i></button>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btnCsometimientoMigracion" onclick="borrar_campos();" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" id="btnGsometimientoMigracion" class="btn btn-success"><i class="fas fa-save"> Guardar</i></button>
                    </div>
                    {!! Form::close() !!}
                </div>
                {{-- END Sometimiento-migracion --}}


                {{-- Comunicacion al CE --}}
                <div style="display: none" id="body-106" name="body-comunicacionalCE">
                    <div class="modal-body">
                        {!! Form::open(['autocomplete' => 'off', 'method'=>'POST', 'id'=>'formcreate_comunicacionalCE']) !!}
        
                        <div class="form-group" id="div1">
                            {!! Form::label('106no1', '1. Ciudad', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-city"></i></span>
                                {!! Form::text('106no1', null, ['class' => 'form-control', 'placeholder' => 'Ciudad', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div2">
                            {!! Form::label('106no2', '2. Fecha', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-calendar"></i></span>
                                {!! Form::date('106no2', null, ['class' => 'form-control', 'required']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div3">
                            {!! Form::label('106no3', '3. Código UIS', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('106no3', null, ['class' => 'form-control', 'placeholder' => 'Código UIS', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div4">
                            {!! Form::label('106no4', '4. Asunto', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-envelope"></i></span>
                                {!! Form::text('106no4', null, ['class' => 'form-control', 'placeholder' => 'Asunto', 'required']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div5">
                            {!! Form::label('106no5', '5. Código', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-folder-open"></i></span>
                                {!! Form::text('106no5', null, ['class' => 'form-control', 'placeholder' => 'Código', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div6">
                            {!! Form::label('106no6', '6. Título', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-pen-square"></i></span>
                                {!! Form::text('106no6', null, ['class' => 'form-control', 'placeholder' => 'Título', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div7">
                            {!! Form::label('106no7', '7. Patrocinador', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('106no7', null, ['class' => 'form-control', 'placeholder' => 'Patrocinador', 'readonly']) !!}
                            </div>
                        </div>
        
                        <div class="form-group" id="div8">
                            {!! Form::label('106no8', '8. Nombre del Investigador principal', ['class' => 'form-label']) !!}
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-user"></i></span>
                                {!! Form::text('106no8', null, ['class' => 'form-control', 'placeholder' => 'Investigador principal', 'readonly']) !!}
                            </div>
                        </div>

                        <div class="form-group" id="div9">
                            {!! Form::label('106no9', '9. Con la finalidad de realizar el estudio arriba mencionado, por la presente:', ['class' => 'form-label']) !!}
                            <div id="wrapper_comunicacionalCE">
                            <div class="input-group-prepend">
                                <span class="input-group-text"><i class="fas fa-pen-square"></i></span>
                                {!! Form::text('106no9', null, ['class' => 'form-control', 'placeholder' => 'Escribir asunto', 'required']) !!}
                                <button type="button" id="add_asunto_comunicacion" class="btn btn-primary" title="Agregar campo"><i class="fas fa-plus-square"></i></button>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" id="btnCcomunicacionalCE" onclick="borrar_campos();" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button>
                        <button type="submit" id="btnGcomunicacionalCE" class="btn btn-success"><i class="fas fa-save"> Guardar</i></button>
                    </div>
                    {!! Form::close() !!}
                </div>
                {{-- END Comunicacion al CE --}}

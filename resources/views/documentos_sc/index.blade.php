...
<h4 class="m-0">Documentos Sitio Clínico</h4>
@stop
            ...
            <div class="card-header">
                ...
                <div class="container-xxl border border-5">
                    ...
                    <ul class="nav nav-pills nav-fill p-1" id="myTab" role="tablist">
                        ...
                        <li class="nav-item p-1" role="presentation">
                            <a class="nav-link" onclick="list_cv()" id="cv-tab" data-bs-toggle="tab" data-bs-target="#cv" type="button" role="tab" aria-controls="cv" aria-selected="false">CV</a>
                        </li>
                    </ul>
                                                ...
                                                <div class="table-responsive">
                                                    <table id="tbl_codigos" class="table table-striped table-hover table-bordered shadow-lg mt-2" style="width:95%;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                <td onclick="list_codigos({{$proyecto->id}});">{{ $proyecto->no18 }}</td>
                                                                <td onclick="list_codigos({{$proyecto->id}});">{{ $proyecto->no20 }}</td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
                                                    </table>
                                        ...
                                        <div id="cv">
                                            ...
                                            <div class="col p-3">
                                                <div class="card-header" align="right">
                                                    <a href="/documentos_sc/cv/esp/0" class="btn btn-primary"><span class="fas fa-file-alt"></span> 
                                                            &nbsp; CV Español</a> 
                                                    {{-- <a href="/documentos_sc/cv/eng/0" class="btn btn-primary"><span class="fas fa-file-alt"></span> 
                                                            &nbsp; CV Ingles</a>  --}}
                                                </div>
                                                <div class="table-responsive" id="table_cv">
                                                    <table id="table-formatoCV" class="table table-striped table-hover table-bordered shadow-lg mt-2" style="width:100%;">
                                                        <thead class="bg-mexg1 text-white">
                                                            <tr>
                                                                <th scope="col">Nombre</th>
                                                                <th scope="col">Correo</th>
                                                                <th scope="col">Teléfono casa</th>
                                                                <th scope="col">Teléfono movil</th>
                                                                <th scope="col">Editar CV español / Editar CV ingles</th>
                                                                <th scope="col">Imprimir CV español PDF / Imprimir CV ingles PDF</th>
...
@section('js')
    ...
    <script src="{{ asset('js/documentos_sc.js?1') }}"></script>
@stop
...
<h4 class="m-0">Documentos Capacitación</h4>
@stop
                                        ...
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-1-tab" data-toggle="pill" href="#vert-tabs-1" onclick="cambiarCapacitacion('assets/B/Ca-B Capacitacion.pdf');" role="tab" aria-controls="vert-tabs-1" aria-selected="false"> Ca-B Capacitación</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-2-tab" data-toggle="pill" href="#vert-tabs-2" onclick="cambiarManuales('assets/B/1M-B Capacitacion.pdf');" role="tab" aria-controls="vert-tabs-2" aria-selected="false"> 1M-B Capacitación</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-3-tab" data-toggle="pill" href="#vert-tabs-3" onclick="cambiarProcesos('assets/B/PC-B Capacitacion.pdf');" role="tab" aria-controls="vert-tabs-3" aria-selected="false"> PC-B Capacitación</a>
                                                    </li> 
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/B/PNO-B-101 Diagnostico.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-B-101 Diagnóstico</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/B/PNO-B-201 Plan.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-B-201 Plan</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/B/PNO-B-301 Contenidos.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-B-301 Contenidos</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/B/PNO-B-401 Intervencion.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-B-401 Intervención</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-4-tab" data-toggle="pill" href="#vert-tabs-4" onclick="cambiarProcedimientos('assets/B/PNO-B-501 Evaluacion.pdf');" role="tab" aria-controls="vert-tabs-4" aria-selected="false"> PNO-B-501 Evaluación</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-5-tab" data-toggle="pill" href="#vert-tabs-5" onclick="cambiarInstructivos('assets/B/IT-B Capacitacion.pdf');" role="tab" aria-controls="vert-tabs-5" aria-selected="false"> IT-B Capacitación</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-5 col-sm-3">
                                        <div class="card">
                                            ...
                                            <div class="card-body p-0">
                                                <ul class="nav flex-column nav-tabs">
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" onclick="cambiarFormatos('assets/B/FC-B-4011 Constancia capacitacion.pptx');" role="tab" aria-controls="vert-tabs-6" aria-selected="false"> FC-B-4011 Constancia capacitación</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" onclick="cambiarFormatos('assets/B/Formato DC-3.docx');" role="tab" aria-controls="vert-tabs-6" aria-selected="false"> Formato DC-3</a>
                                                    </li>
                                                    <li class="nav-item">
                                                        <a class="nav-link" id="vert-tabs-6-tab" data-toggle="pill" href="#vert-tabs-6" onclick="cambiarFormatos('assets/B/Formato-DC-5.pdf');" role="tab" aria-controls="vert-tabs-6" aria-selected="false"> Formato DC-5</a>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
...
@section('js')
    ...
    <script src="{{ asset('js/documentos_capacitacion.js?1') }}"></script>
@stop
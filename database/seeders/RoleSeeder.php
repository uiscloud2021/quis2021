...
class RoleSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Permission::create(['name' => 'dashboard', 'description' => 'Inicio Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.show', 'description' => 'Directorios Servidor QUIS'])->syncRoles([$role1, $role2]);
        ...
        Permission::create(['name' => 'dashboard.list_files', 'description' => 'Lista de archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.delete_files', 'description' => 'Borrar archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.edit_files', 'description' => 'Cargar edición de archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.details', 'description' => 'Detalles Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.created_files', 'description' => 'Crear archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.download_files', 'description' => 'Descargar archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.update_files', 'description' => 'Editar archivos Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.comprimir_files', 'description' => 'Comprimir archivos Servidor QUIS'])->syncRoles([$role1, $role2]);

        Permission::create(['name' => 'dashboard.folderdetails', 'description' => 'Detalles carpetas Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.create_folder', 'description' => 'Crear carpeta Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.edit_folder', 'description' => 'Cargar edición de carpeta Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.update_folder', 'description' => 'Editar carpeta Servidor QUIS'])->syncRoles([$role1, $role2]);
        Permission::create(['name' => 'dashboard.delete_folder', 'description' => 'Eliminar carpeta Servidor QUIS'])->syncRoles([$role1, $role2]);

...
function list_codigos(proyecto_id){
    $.ajax({
        url: "/documentos_ce/codigos_nombre",
        method:'POST',
        type: 'post',
...
function list_formatos(){
    ...
    var list = $('#table-formato').DataTable({
            ...
            "ajax":{
                "url": "/documentos_ce/list_formatos",
                "method": "POST",
                "data": {
...
function delete_formatos(formato_id) {
    ...
    $('#btnEliminarRegistro').click(function(){
        $.ajax({
            url: "/documentos_ce/delete_formato",
            method:'POST',
            type: 'post',
...
function download_formatos(directorio) {
    // alert(directorio);
    window.open('/documentos_ce/download_formato/' + directorio, '_blank');
}
...
function download_formatos_datos() {
    ...
    $.ajax({
        url: "/documentos_ce/create_formato",
        method:'POST',
        type: 'post',
        ...
        success:function(resp){
            ...
            if(resp){
                borrar_campos();
                list_formatos();
                window.open('/documentos_ce/descargar/word/' + resp, '_blank');
            }else{
                borrar_campos();
...
function edit_formatos(formato_id) {
    ...
    documento_formato_id = $("#doc_formatos").val();
    $.ajax({
        url: "/documentos_ce/edit_formato",
        method:'POST',
        dataType: 'json',
        data:{formato_id:formato_id, _token:$('input[name="_token"]').val()},
        success:function(data){
...
function cargarDatosProtocolo() {
    ...
    $.ajax({
        url: "/documentos_ce/datos_protocolo",
        method: 'POST',
        dataType: 'json',
        data: {
